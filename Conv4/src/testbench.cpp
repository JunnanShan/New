...
void conv4(DataType inp_img[(INP_IMAGE_SIZE-2*PAD) * (INP_IMAGE_SIZE-2*PAD) * INP_IMAGE_CHANNEL],
...
int main()
{
    ifstream inp_file("/home/junnan/Work/Vivado_HLS/conv4_new/out_conv3.txt");
    DataType *inp_image;
	...
	ifstream filter_file("/home/junnan/Work/Vivado_HLS/conv4_new/conv4Weights.txt");
	    DataType *filter;
		...
		ifstream bias_file("/home/junnan/Work/Vivado_HLS/conv4_new/conv4Bias.txt");
		    DataType *bias;
  ...
  ofstream data("/home/junnan/Work/Vivado_HLS/conv4_new/out_image.txt");
